...
public:
  ...
  double Threshold_1 = -16; //To be changed //-7 
  double Threshold_2 = -18; // To be changed //-10 
  ...
  uint16_t pre_PingpongCell = 0; // pre-pre-cell
  

  // MRO
  int NumOfHo = 0;
  int PingpongCnt = 0;
  uint16_t PingpongCell = 0; // pre-cell
