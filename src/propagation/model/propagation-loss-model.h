...
////////////////////////////////////////////
class TerahertzPropagationLossModel : public PropagationLossModel
{
...
private:
   ...
   * Defined and unimplemented to avoid misuse
   */
  TerahertzPropagationLossModel (const TerahertzPropagationLossModel &);
  /**
   * \brief Copy constructor
   *
   * Defined and unimplemented to avoid misuse
   * \returns
   */
  TerahertzPropagationLossModel & operator = (const TerahertzPropagationLossModel &);
...
private:
   ...
   * Defined and unimplemented to avoid misuse
   */
  MmWavePropagationLossModel (const MmWavePropagationLossModel &);
  /**
   * \brief Copy constructor
   *
   * Defined and unimplemented to avoid misuse
   * \returns
   */
  MmWavePropagationLossModel & operator = (const MmWavePropagationLossModel &);

  virtual double DoCalcRxPower (double txPowerDbm,
                                Ptr<MobilityModel> a,
                                Ptr<MobilityModel> b) const;
  
  std::tuple< Ptr<MobilityModel>, Ptr<MobilityModel> >GetEnbUePair(Ptr<MobilityModel> a, Ptr<MobilityModel> b) const;
