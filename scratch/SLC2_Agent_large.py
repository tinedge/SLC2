...
if __name__ == "__main__" :
    ...
    Q1_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable1_QLB_large.csv"))
    Q2_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable2_QLB_large.csv"))
    Q3_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable3_QLB_large.csv"))
    Q4_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable4_QLB_large.csv"))
    Q5_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable5_QLB_large.csv"))
    Q6_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable6_QLB_large.csv"))
    Q7_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable7_QLB_large.csv"))
    Q8_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable8_QLB_large.csv"))
    Q9_Mlb = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable9_QLB_large.csv"))

    Q1_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable1_QMRO_large.csv"))
    Q2_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable2_QMRO_large.csv"))
    Q3_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable3_QMRO_large.csv"))
    Q4_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable4_QMRO_large.csv"))
    Q5_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable5_QMRO_large.csv"))
    Q6_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable6_QMRO_large.csv"))
    Q7_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable7_QMRO_large.csv"))
    Q8_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable8_QMRO_large.csv"))
    Q9_Mro = np.array(csv2list("/dir/SLC2/Qtable/large/Qtable9_QMRO_large.csv"))
